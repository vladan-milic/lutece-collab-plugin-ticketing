...
(202, 2, "TICKET_INPUT", 206, NULL, "Numéro de compte Facil'familles", "", "", 1, 0, 1, NULL, 0, NULL, 0, "", "", 0, "Le numéro de compte Facil'familles est un champ obligatoire, veuillez le renseigner.", 0, 0, 0, "FFAccountNumber");
