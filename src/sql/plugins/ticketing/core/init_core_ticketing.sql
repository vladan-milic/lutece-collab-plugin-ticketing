...
--
UPDATE core_feature_group SET feature_group_order = feature_group_order + 2 WHERE id_feature_group NOT LIKE "TICKETING%";
DELETE FROM core_feature_group WHERE id_feature_group LIKE "TICKETING%"; 
...
INSERT INTO core_feature_group (id_feature_group, feature_group_description, feature_group_label, feature_group_order) VALUES ('TICKETING_ADMIN','ticketing.adminFeature.group.ticketing_admin.description','ticketing.adminFeature.group.ticketing_admin.label',2);
...
INSERT INTO core_admin_right (id_right,name,level_right,admin_url,description,is_updatable,plugin_name,id_feature_group,icon_url,documentation_url, id_order ) VALUES 
('TICKETING_MANAGEMENT','ticketing.adminFeature.ManageAdminTicketing.name',1,'jsp/admin/plugins/ticketing/admin/ManageTicketCategorys.jsp','ticketing.adminFeature.ManageAdminTicketing.description',0,'ticketing','TICKETING_ADMIN',NULL,NULL,1);
...
INSERT INTO core_admin_right (id_right,name,level_right,admin_url,description,is_updatable,plugin_name,id_feature_group,icon_url,documentation_url, id_order ) VALUES 
('TICKETING_PLUGIN_CONFIGURATION','ticketing.adminFeature.ConfigurePlugin.name',1,'jsp/admin/plugins/ticketing/config/ConfigurePlugin.jsp','ticketing.adminFeature.ConfigurePlugin.description',0,'ticketing','TICKETING_ADMIN',NULL,NULL,4);
