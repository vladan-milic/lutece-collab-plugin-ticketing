...
INSERT INTO core_admin_right (`id_right`, `name`, `level_right`, `admin_url`, `description`, `is_updatable`, `plugin_name`, `id_feature_group`, `icon_url`, `documentation_url`, `id_order`) VALUES
('TICKETING_MANAGEMENT_REPONSES_TYPE', 'ticketing.adminFeature.ManageTicketingReponsesTypes.name', '2', 'jsp/admin/plugins/ticketing/admin/ManageTypicalResponses.jsp', 'ticketing.adminFeature.ManageTicketingReponsesTypes.description', '0', 'ticketing', "GRU", NULL, NULL, '23');
